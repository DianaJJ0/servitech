...
(function () {
  ...
  function createExpertRow(expert, categoriesMap) {
    ...
    if (!avatar || avatar === "/assets/img/default-avatar.png" || avatar.includes("ui-avatars.com/api/?name=User")) {
      ...
      const initials = name
        ...
        .toUpperCase()
        .substring(0, 2);
      avatar = `https://ui-avatars.com/api/?name=${encodeURIComponent(initials)}&background=4f46e5&color=ffffff&size=40`;
    }
        ...
        try {
          ...
          if (currentUserData && currentUserData !== lastUserData) {
            ...
            if (currentUser.avatarUrl !== lastUser.avatarUrl) {
              console.log("[admin-expertos] Avatar actualizado, refrescando vista...");
